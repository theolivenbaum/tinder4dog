(function () {
  ...
  function updateCards(event) {
    ...
    const next = document.querySelector('.item--next');
    const details = document.querySelector('tinder4dog-details');
    top.style.transform = '';
    top.selected = 0;
    top.data = next.data;
  ...
  function showDetails(event) {
    ...
    const carousel = document.querySelector('tinder4dog-carousel');
    const image = document.querySelector('.view--swipelist .item--top picture');
    details.querySelector('tinder4dog-details').data = data;
